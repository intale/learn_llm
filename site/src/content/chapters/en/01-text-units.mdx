...
Chapter 3 learns BPE merge rules, and chapter 4 applies them to replace scalar-sized
units while preserving this integer-sequence interface. Everything that follows—
