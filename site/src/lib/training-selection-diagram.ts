...
export interface TrainingSelectionDiagramLabels {
  ...
  readonly cues: {
    ...
    readonly parameterNodesPreserved: string;
    readonly gradientsCleared: string;
  };
  readonly proofs: {
...
const expectedLines = [
  ...
  "UPDATE|step=1|batch=train-b@2,train-b@8|learning_rate=0.040000|train_loss=2.453998|grad_norm_before=4.051362|grad_norm_after=0.350000|clipped=true|finite=true|nodes_preserved=true|cleared=true",
  "UPDATE|step=2|batch=train-a@0,train-b@9|learning_rate=0.040000|train_loss=1.636732|grad_norm_before=3.113352|grad_norm_after=0.350000|clipped=true|finite=true|nodes_preserved=true|cleared=true",
  "UPDATE|step=3|batch=train-a@7,train-b@0|learning_rate=0.025000|train_loss=1.809688|grad_norm_before=1.861960|grad_norm_after=0.350000|clipped=true|finite=true|nodes_preserved=true|cleared=true",
  "UPDATE|step=4|batch=train-a@1,train-b@7|learning_rate=0.025000|train_loss=1.116494|grad_norm_before=1.535791|grad_norm_after=0.350000|clipped=true|finite=true|nodes_preserved=true|cleared=true",
  "UPDATE|step=5|batch=train-a@2,train-a@6|learning_rate=0.015000|train_loss=1.169224|grad_norm_before=1.697376|grad_norm_after=0.350000|clipped=true|finite=true|nodes_preserved=true|cleared=true",
  "UPDATE|step=6|batch=train-a@3,train-a@4|learning_rate=0.015000|train_loss=1.771533|grad_norm_before=1.706953|grad_norm_after=0.350000|clipped=true|finite=true|nodes_preserved=true|cleared=true",
  "UPDATE|step=7|batch=train-b@4,train-a@5|learning_rate=0.008000|train_loss=1.019272|grad_norm_before=1.168497|grad_norm_after=0.350000|clipped=true|finite=true|nodes_preserved=true|cleared=true",
  "UPDATE|step=8|batch=train-a@8,train-a@9|learning_rate=0.008000|train_loss=1.698170|grad_norm_before=1.490535|grad_norm_after=0.350000|clipped=true|finite=true|nodes_preserved=true|cleared=true",
  ...
  "PROOF|fixed_seed_batches=true|schedule_exact=true|finite_gradients=true|parameter_nodes_preserved=true|cleared_gradients=true|clipping_observed=true|train_loss_decreased=true|validation_no_grad=true|selection_matches_argmin=true|test_partition_rejected=true|replay_bitwise=true|input_unchanged=true",
  ...
  const updates = Object.freeze(
    lines.slice(7, 15).map((line, index) => {
      ...
      if (
        ...
        required(value, "nodes_preserved") !== "true" ||
        required(value, "cleared") !== "true"
      ) {
        invalid("update clipping, finite, node-identity, or gradient-clearing evidence disagrees");
      }
