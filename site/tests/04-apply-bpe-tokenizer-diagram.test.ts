...
const russianLabels: ApplyBpeTokenizerDiagramLabels = {
  ...
  description: 'Проследите два входа от байтов UTF-8 до ID документа и обратно.',
  caseTitles: {
  ...
  lanes: {
    ...
    initial: 'Исходные ID байтовых токенов',
  ...
  invariants: {
    ranks: 'Зафиксированные ранги применяются по возрастанию.',
    offset: 'Каждый ID содержимого равен ID обучения плюс два.',
    controls: 'BOS и EOS находятся только на краях документа.',
    bytes: 'Байты частей складываются в точный вход.',
  },
};
