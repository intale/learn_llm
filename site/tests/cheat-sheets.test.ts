...
const expectedSheets = {
  ...
  '18-token-embeddings': {
    ...
    entries: [
      ...
      ['Gather operation', 'The forward half copies one selected row into each output position'],
  ...
  '33-training-selection': {
    ...
    entries: [
      ...
      ['Clipped gradient', 'globally clipped gradient AdamW uses to update both moments'],
  ...
  '37-incremental-attention': {
    ...
    entries: [
      ...
      ['Current query', 'this implementation does\nnot store them in the cache.'],
...
const exactDefinitions = {
  ...
  '33-training-selection': {
    ...
    'Clipped gradient': 'The raw gradient after the shared global scale: the globally clipped gradient AdamW uses to update both moments.',
  ...
  it('grounds the reviewed Chapter 3 Russian terms in the natural lesson explanations', () => {
    ...
    const expected = [
      ...
      },
      {
        ...
        lessonEvidence: 'правила будут применяться к произвольным байтам UTF-8 по возрастанию ранга',
      },
      {
      ...
      },
      {
        ...
        lessonEvidence: 'один исходный токен нельзя использовать дважды в одном проходе',
      },
      {
