...
const copy = {
  ...
  ru: {
    ...
    chapterTitle: 'Детерминированное обучение слияний BPE',
    revisionLabel: 'Версия материала',
    headings: {
      formula: 'Выберите одно воспроизводимое правило',
      history: 'От закрытой таблицы слов к повторному слиянию пар',
    ...
    rustCaptions: [
      'Детерминированная таблица целых слов с одним неизвестным ID',
      'Подсчёт кандидатов с перекрытиями и числовое разрешение равенства',
      'Замена слева направо без повторного использования входного токена',
      'Исходные последовательности только из обучающей выборки',
      'Обучение по зафиксированному корпусу и проверяемая трассировка',
    ],
    diagramTitle: 'Два детерминированных раунда слияний BPE',
