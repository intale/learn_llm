...
The English-only example above matches the current Chapter 14–39 active sets;
Chapters 0–13 use English and Russian. A registered but inactive locale gets no
