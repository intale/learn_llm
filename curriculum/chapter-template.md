...
The English-only example above matches the current Chapter 15–39 active sets;
Chapters 0–14 use English and Russian. A registered but inactive locale gets no
