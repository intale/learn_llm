...
The English-only example above matches the current Chapter 19–39 active sets;
Chapters 0–18 use English and Russian. A registered but inactive locale gets no
