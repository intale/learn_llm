...
The English-only example above matches the current Chapter 9–39 active sets;
Chapters 0–8 use English and Russian. A registered but inactive locale gets no
