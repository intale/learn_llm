...
The English-only example above matches the current Chapter 10–39 active sets;
Chapters 0–9 use English and Russian. A registered but inactive locale gets no
