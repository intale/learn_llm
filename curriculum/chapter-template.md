...
The English-only example above matches the current Chapter 25–39 active sets;
Chapters 0–24 use English and Russian. A registered but inactive locale gets no
