...
The English-only example above matches the current Chapter 18–39 active sets;
Chapters 0–17 use English and Russian. A registered but inactive locale gets no
