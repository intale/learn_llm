...
The English-only example above matches the current Chapter 36–39 active sets;
Chapters 0–35 use English and Russian. A registered but inactive locale gets no
