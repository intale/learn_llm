...
The English-only example above matches the current Chapter 16–39 active sets;
Chapters 0–15 use English and Russian. A registered but inactive locale gets no
