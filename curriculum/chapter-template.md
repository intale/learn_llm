...
The English-only example above matches the current Chapter 26–39 active sets;
Chapters 0–25 use English and Russian. A registered but inactive locale gets no
