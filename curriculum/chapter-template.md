...
The English-only example above matches the current Chapter 22–39 active sets;
Chapters 0–21 use English and Russian. A registered but inactive locale gets no
