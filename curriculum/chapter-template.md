...
The English-only example above matches the current Chapter 20–39 active sets;
Chapters 0–19 use English and Russian. A registered but inactive locale gets no
