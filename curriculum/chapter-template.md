...
The English-only example above matches the current Chapter 0 and Chapter 8–39
active sets; Chapters 1–7 use English and Russian. A registered but inactive locale gets no
