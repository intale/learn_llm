...
The English-only example above matches the current Chapter 13–39 active sets;
Chapters 0–12 use English and Russian. A registered but inactive locale gets no
