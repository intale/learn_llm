...
The English-only example above matches the current Chapter 35–39 active sets;
Chapters 0–34 use English and Russian. A registered but inactive locale gets no
