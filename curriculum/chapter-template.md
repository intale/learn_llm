...
The English-only example above matches the current Chapter 27–39 active sets;
Chapters 0–26 use English and Russian. A registered but inactive locale gets no
