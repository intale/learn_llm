...
The English-only example above matches the current Chapter 12–39 active sets;
Chapters 0–11 use English and Russian. A registered but inactive locale gets no
