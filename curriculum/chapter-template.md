...
The English-only example above matches the current Chapter 24–39 active sets;
Chapters 0–23 use English and Russian. A registered but inactive locale gets no
