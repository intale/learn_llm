...
The English-only example above matches the current Chapter 33–39 active sets;
Chapters 0–32 use English and Russian. A registered but inactive locale gets no
