...
The English-only example above matches the current Chapter 17–39 active sets;
Chapters 0–16 use English and Russian. A registered but inactive locale gets no
