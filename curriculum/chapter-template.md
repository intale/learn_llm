...
The English-only example above matches the current Chapter 23–39 active sets;
Chapters 0–22 use English and Russian. A registered but inactive locale gets no
