...
The English-only example above matches the current Chapter 37–39 active sets;
Chapters 0–36 use English and Russian. A registered but inactive locale gets no
