...
The English-only example above matches the current Chapter 8–39 active sets;
Chapters 0–7 use English and Russian. A registered but inactive locale gets no
