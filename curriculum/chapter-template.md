...
The English-only example above matches the current Chapter 32–39 active sets;
Chapters 0–31 use English and Russian. A registered but inactive locale gets no
