...
Chapters 0–9 publish one exact English/Russian locale pair per chapter. The
current revisions of Chapters 1–9 are 5, 4, 4, 4, 4, 4, 3, 5, and 5 respectively
...
Chapters 0–9 and English only for Chapters 10–39. Russian keeps its localized index
